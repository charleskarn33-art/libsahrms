...
export function WhtTrendChart({ data }: { data: { period: string; total: number }[] }) {
  return (
    <Card>
      <CardHeader className="flex-row items-center justify-between space-y-0">
        <CardTitle>Tax (WHT) Trend</CardTitle>
      ...
      <CardContent className="h-[260px] pl-0">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
            <defs>
              <linearGradient id="whtFill" x1="0" y1="0" x2="0" y2="1">
            ...
            />
            <Area type="monotone" dataKey="total" stroke="#0057FF" strokeWidth={2.5} fill="url(#whtFill)" />
          </AreaChart>
        </ResponsiveContainer>
      </CardContent>
    </Card>
